...
export function Legend() {
  return (
    <div
      ...
      className="absolute bottom-[116px] right-4 z-30 flex items-center gap-[14px] rounded-full border border-white/[0.08] bg-[color:var(--nafas-bg)]/62 px-[14px] py-[6px] shadow-[0_18px_48px_-18px_rgba(0,0,0,0.9),0_0_0_1px_rgba(255,255,255,0.02)_inset] backdrop-blur-2xl"
    >
      <span
